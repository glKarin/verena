...
class VDeveloper : public QObject
{
	...
	public:
		...
		Q_INVOKABLE void openExternEditor(const QString &file, const QString &terminal = QString("/usr/bin/meego-terminal"), const QString &editor = QString("/usr/bin/vi"), bool su = false) const;
