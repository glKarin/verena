		...
		delegate:Component{
			Rectangle{
				...
				Item{
                    ...
                    height:screen.currentOrientation === Screen.Portrait || screen.currentOrientation === Screen.PortraitInverted ? 40 : parent.height;
                    width:screen.currentOrientation === Screen.Portrait || screen.currentOrientation === Screen.PortraitInverted ? parent.width : 40;
					ToolIcon{
                        width:40;
						height:width;
						anchors{
