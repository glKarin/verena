...
Item{
	...
	StreamtypesDialog{
		...
		onRequestParse:{
			Parser.loadSource(vid, "youku", vplayer, [type], [part]);
		}
	}
		...
		delegate:Component{
			Rectangle{
				...
				Item{
					...
					height:screen.currentOrientation === Screen.Portrait || screen.currentOrientation === Screen.PortraitInverted ? 50 : parent.height;
					width:screen.currentOrientation === Screen.Portrait || screen.currentOrientation === Screen.PortraitInverted ? parent.width : 50;
					ToolIcon{
						width:40;
						height:width;
						anchors{
